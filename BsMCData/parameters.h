...
const int NBins = 1;
const double ptBins[NBins+1]={5,50};
...
const int CosBdtheta = 5;
const double CosBdthetaMin = -0.5;
const double CosBdthetaMax = 0.5;


const int NBDT5to10 = 6;
const double BDT5to10Min = 0.2;
const double BDT5to10Max = 0.6;


const int NBDT10to15 = 6;
const double BDT10to15Min = 0.2;
const double BDT10to15Max = 0.5;

const int NBDT15to20 = 6;
const double BDT15to20Min = 0.2;
const double BDT15to20Max = 0.5;

const int NBDT20to50 = 6;
const double BDT20to50Min = 0.3;
const double BDT20to50Max = 0.5;
...
double Binning[NVar] ={NBDT5to10,NBDT10to15,NBDT15to20,NBDT20to50};
double Min[NVar] ={BDT5to10Min,BDT10to15Min,BDT15to20Min,BDT20to50Min};
double Max[NVar] ={BDT5to10Max,BDT10to15Max,BDT15to20Max,BDT20to50Max};


double MaxY[NVar] ={1.0,1.0,1.0,1.0};
/*
   const int NRatio = 20;
   double Ratiomin = 0;
   double Ratiomax = 50;
...
TString VarSData[NVar] = {"BDT5to10hisSData","BDT10to15hisSData","BDT15to20hisSData","BDT20to50hisSData"};
TString VarBData[NVar] = {"BDT5to10hisBData","BDT10to15hisBData","BDT15to20hisBData","BDT20to50hisBData"};
TString VarYData[NVar] = {"BDT5to10hisYData","BDT10to15hisYData","BDT15to20hisYData","BDT20to50hisYData"};

TString VarSMC[NVar] = {"BDT5to10hisSMC","BDT10to15hisSMC","BDT15to20hisSMC","BDT20to50hisSMC"};
TString VarBMC[NVar] = {"BDT5to10hisBMC","BDT10to15hisBMC","BDT15to20hisBMC","BDT20to50hisBMC"};
TString VarYMC[NVar] = {"BDT5to10hisYMC","BDT10to15hisYMC","BDT15to20hisYMC","BDT20to50hisYMC"};
TString VarGMC[NVar] = {"BDT5to10hisGMC","BDT10to15hisGMC","BDT15to20hisGMC","BDT20to50hisGMC"};



TString VarYMCRatio[NVar] = {"BDT5to10hisYRatioMC","BDT10to15hisYRatioMC","BDT15to20hisYRatioMC","BDT20to50hisYRatioMC"};
TString VarGMCRatio[NVar] = {"BDT5to10hisGRatioMC","BDT10to15hisGRatioMC","BDT15to20hisGRatioMC","BDT20to50hiGRatioMC"};


TString Var[NVar] = {"BDT_pt_5_10","BDT_pt_10_15","BDT_pt_15_20","BDT_pt_20_50"};
TString Name[NVar] = {"BDT5to10","BDT10to15","BDT15to20","BDT20to50"};
TString XName[NVar] = {"BDT5to10","BDT10to15","BDT15to20","BDT20to50"};
TString YName[NVar] = {"Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts"};
TString HisName[NVar] = {"Normalized BDT 5 to 10 Distribution","Normalized BDT 10 to 15 Distribution","Normalized BDT 15 to 20 Distribution","Normalized BDT 20 to 50 Distribution"};
