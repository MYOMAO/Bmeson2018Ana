...
DESTINATION="/mnt/hadoop/cms/store/user/zzshi/BsAna/BsBDTOfficialMCNew15-20"

DESTINATION2="/cms/store/user/zzshi/BsAna/BsBDTOfficialMCNew15-20"

###Folder location within which files are to be run
#DATASET="/mnt/hadoop/cms/store/user/szhaozho/BsJobs/outputfilesOfficialMCAll/"
...
#DATASET2="/cms/store/user/szhaozho/BsJobs/outputfilesOfficialMCAll/"
