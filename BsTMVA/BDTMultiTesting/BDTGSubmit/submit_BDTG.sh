...
LOGDIR="/work/zzshi/CMSSW_7_5_8_patch3/src/BsBDTService/BDTGSubmit/log"
########################## Create subfile ###############################
...
DESTINATION="/mnt/hadoop/cms/store/user/zzshi/BsAna/BsBDTGCalculated"

DESTINATION2="/cms/store/user/zzshi/BsAna/BsBDTGCalculated"
...
do
    ...
    ifexist=`ls $DESTINATION/BDTG_$i`
    if [ -z $ifexist ]
    then
...
Universe = vanilla
Initialdir = .
Executable = exec_BDTG.sh
+AccountingGroup = "group_cmshi.$(whoami)"
Arguments =  $CONFIGFILE $DESTINATION2 BDTG_${infn} $INFILE $INFILE2
GetEnv       = True
Input = /dev/null
