...
LOGDIR="/work/zzshi/CMSSW_7_5_8_patch3/src/BsBDTService/BDTSubmit/log"
########################## Create subfile ###############################
...
DESTINATION="/mnt/hadoop/cms/store/user/zzshi/BsAna/BsBDTOfficialMC6"

DESTINATION2="/cms/store/user/zzshi/BsAna/BsBDTOfficialMC6"
