...
DESTINATION="/mnt/hadoop/cms/store/user/zzshi/BsAna/BDTType/BsBDTFOfficialMCNew5-10"

DESTINATION2="/cms/store/user/zzshi/BsAna/BDTType/BsBDTFOfficialMCNew5-10"
