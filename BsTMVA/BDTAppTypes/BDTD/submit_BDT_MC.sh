...
DESTINATION="/mnt/hadoop/cms/store/user/zzshi/BsAna/BDTType/BsBDTDOfficialMCNew5-10"

DESTINATION2="/cms/store/user/zzshi/BsAna/BDTType/BsBDTDOfficialMCNew5-10"

###Folder location within which files are to be run
DATASET="/mnt/hadoop/cms/store/user/zzshi/BsAna/outputfilesOfficialMCAll/"


DATASET2="/cms/store/user/zzshi/BsAna/outputfilesOfficialMCAll/"
