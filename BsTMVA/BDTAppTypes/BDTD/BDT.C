...
#include "TMVA_BDTD_PbPb_pt_5p0_10p0.class.C"
...
void BDT(TString infname, TString ofname)
{
	...
	outf->cd();
	TTree* mvaTree = new TTree("BDT_pt_5_10","BDT");	

	double BDT[MAX_XB];
	mvaTree->Branch("Bsize",&Bsize,"Bsize/I");
	mvaTree->Branch("BDT_pt_5_10",BDT,"BDT_pt_5_10[Bsize]/D");
