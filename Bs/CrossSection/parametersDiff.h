...
//const int nBins=2;
//double ptBins[nBins+1] = {0,60,180};

//const int nBins=1;
//double ptBins[nBins+1] = {0,180};
...
//const int nBinsY=3;
//double ptBinsY[nBinsY+1] = {0.0,0.7, 1.5, 2.4};
...
double sf_pbpb[4] = {1.0922,1.1434,1.1201,1.0630};

double sf_pbpb030[3] = {1.1359,1.1181,1.0592};
double sf_pbpb090[3] = {1.1371,1.1200,1.0606};
double sf_pbpb3090[3] = {1.1398,1.1248,1.0648};
