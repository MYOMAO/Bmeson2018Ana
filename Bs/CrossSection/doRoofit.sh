...
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_1ST=0
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_2ND=0
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_1ST_Y=0
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_2ND_Y=0
...
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_1ST=0
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_2ND=0
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_1ST_Y=0
DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_2ND_Y=0


CENTPbPbMIN=0
CENTPbPbMAX=90

INPUTMCPbPbCANDWISE_BS="/export/d00/scratch/zzshi/CMSSW_7_5_8_patch3/Merge/JuliaFitSample/selected_mc_ntphi_PbPb_2018_corrected.root"
INPUTDATAPbPbCANDWISE_BS="/export/d00/scratch/zzshi/CMSSW_7_5_8_patch3/Merge/JuliaFitSample/selected_data_ntphi_PbPb_2018_test_onlyevtscuts+mass.root"  

INPUTMCPbPbCANDWISE_BP="/afs/cern.ch/work/j/jusilva/CMSSW_7_5_8_patch5/src/UserCode/Bmeson2018Ana/Bs/CrossSection/cut_trees/selected_mc_ntKp_PbPb_2018_corrected_test.root"
INPUTDATAPbPbCANDWISE_BP="/afs/cern.ch/work/j/jusilva/CMSSW_7_5_8_patch5/src/UserCode/Bmeson2018Ana/Bs/CrossSection/cut_trees/selected_data_ntKp_PbPb_2018_corrected_test.root"  
...
OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_1ST="ROOTfiles/yields_Bp_binned_cent_1st_pt.root"
OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_2ND="ROOTfiles/yields_Bp_binned_cent_2nd_pt.root"
...
OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_1ST_Y="ROOTfiles/yields_Bp_binned_cent_1st_y.root"
OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_2ND_Y="ROOTfiles/yields_Bp_binned_cent_2nd_y.root"
...
root -b  -q 'roofitB.C+('1','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"Bpt\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_DOUBLE_1ST\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_2ND  -eq 1  ]; then
root -b  -q 'roofitB.C+('2','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"Bpt\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_DOUBLE_2ND\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_1ST_Y  -eq 1  ]; then
root -b  -q 'roofitB.C+('1','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"abs\(By\)\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_DOUBLE_1ST_Y\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BS_2ND_Y  -eq 1  ]; then
root -b  -q 'roofitB.C+('2','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"abs\(By\)\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_DOUBLE_2ND_Y\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'
...
root -b  -q 'roofitB.C+('0','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"Bpt\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_BINNED_PT\"','\"plotFits/final_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_Y_BS  -eq 1  ]; then
root -b  -q 'roofitB.C+('0','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"abs\(By\)\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_BINNED_Y\"','\"plotFits/final_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'
...
root -b  -q 'roofitB.C+('0','\"ntphi\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"HiBin\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_BINNED_CENT\"','\"plotFits/final_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'
...
root -b  -q 'roofitB.C+('0','\"ntphi\"','1','1','0','\"$INPUTDATAPbPbCANDWISE_BS\"','\"$INPUTMCPbPbCANDWISE_BS\"','\"Bpt\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BS_FULL\"','\"plotFits/final_roofit\"','\"$NPROOFIT_PbPb\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'
...
if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_1ST  -eq 1  ]; then
root -b  -q 'roofitB.C+('1','\"ntKp\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BP\"','\"$INPUTMCPbPbCANDWISE_BP\"','\"Bpt\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_1ST\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb_BP\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_2ND -eq 1  ]; then
root -b  -q 'roofitB.C+('2','\"ntKp\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BP\"','\"$INPUTMCPbPbCANDWISE_BP\"','\"Bpt\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_2ND\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb_BP\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_1ST_Y  -eq 1  ]; then
root -b  -q 'roofitB.C+('1','\"ntKp\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BP\"','\"$INPUTMCPbPbCANDWISE_BP\"','\"abs\(By\)\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_1ST_Y\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb_BP\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'

rm roofitB_C.d roofitB_C_ACLiC_dict_rdict.pcm roofitB_C.so
fi

if [ $DOANALYSISPbPb_ROOFIT_BINNED_DOUBLE_BP_2ND_Y -eq 1  ]; then
root -b  -q 'roofitB.C+('2','\"ntKp\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BP\"','\"$INPUTMCPbPbCANDWISE_BP\"','\"abs\(By\)\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_DOUBLE_2ND_Y\"','\"plotFits/doubly_roofit\"','\"$NPROOFIT_PbPb_BP\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'
...
root -b  -q 'roofitB.C+('0','\"ntKp\"','0','1','0','\"$INPUTDATAPbPbCANDWISE_BP\"','\"$INPUTMCPbPbCANDWISE_BP\"','\"HiBin\"','\"$TRGPbPb\"','\"$CUTPbPb\"','\"$SELGENPbPb\"','$ISMCPbPb','1','$ISDOWEIGHTPbPb','\"$LABELPbPb\"','\"$OUTPUTFILEPbPbSAVEHIST_ROOFIT_BP_BINNED_CENT\"','\"plotFits/final_roofit\"','\"$NPROOFIT_PbPb_BP\"','0','$CENTPbPbMIN','$CENTPbPbMAX')'
