...
//=========  (Sun Sep 15 19:56:07 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.02559711);
   hEff2->SetBinContent(2,0.02781278);
   hEff2->SetBinContent(3,0.0266526);
   hEff2->SetBinContent(4,0.05733447);
   hEff2->SetBinError(1,0.0004774557);
   hEff2->SetBinError(2,0.0005342999);
   hEff2->SetBinError(3,0.0006088418);
   hEff2->SetBinError(4,0.001060498);
   hEff2->SetEntries(9397.68);
   hEff2->SetStats(0);
