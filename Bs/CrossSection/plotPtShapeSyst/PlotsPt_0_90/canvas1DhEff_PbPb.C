...
//=========  (Mon Sep 16 04:54:41 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.0006368276);
   hEff2->SetBinContent(2,0.01495824);
   hEff2->SetBinContent(3,0.05183168);
   hEff2->SetBinContent(4,0.107203);
   hEff2->SetBinError(1,4.37176e-05);
   hEff2->SetBinError(2,0.0003313437);
   hEff2->SetBinError(3,0.0008649368);
   hEff2->SetBinError(4,0.001072649);
   hEff2->SetEntries(15168.97);
   hEff2->SetStats(0);
