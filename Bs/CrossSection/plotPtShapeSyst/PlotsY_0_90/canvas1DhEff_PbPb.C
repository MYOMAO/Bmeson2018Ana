...
//=========  (Mon Sep 16 04:49:48 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.01745585);
   hEff2->SetBinContent(2,0.01765862);
   hEff2->SetBinContent(3,0.01602974);
   hEff2->SetBinContent(4,0.03526663);
   hEff2->SetBinError(1,0.0003289185);
   hEff2->SetBinError(2,0.0003444281);
   hEff2->SetBinError(3,0.0003832075);
   hEff2->SetBinError(4,0.000666396);
   hEff2->SetEntries(9130.951);
   hEff2->SetStats(0);
