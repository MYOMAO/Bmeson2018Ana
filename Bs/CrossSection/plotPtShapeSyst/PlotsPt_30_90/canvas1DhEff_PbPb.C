...
//=========  (Sun Sep 15 20:00:55 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.001325372);
   hEff2->SetBinContent(2,0.02543875);
   hEff2->SetBinContent(3,0.08224812);
   hEff2->SetBinContent(4,0.1591431);
   hEff2->SetBinError(1,8.828758e-05);
   hEff2->SetBinError(2,0.0005322665);
   hEff2->SetBinError(3,0.001284925);
   hEff2->SetBinError(4,0.00150375);
   hEff2->SetEntries(17106.94);
   hEff2->SetStats(0);
