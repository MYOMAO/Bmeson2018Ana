...
//=========  (Sun Sep 15 19:46:29 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.01573932);
   hEff2->SetBinContent(2,0.01556854);
   hEff2->SetBinContent(3,0.0135523);
   hEff2->SetBinContent(4,0.03089524);
   hEff2->SetBinError(1,0.000410424);
   hEff2->SetBinError(2,0.0004207195);
   hEff2->SetBinError(3,0.0004498523);
   hEff2->SetBinError(4,0.0007972008);
   hEff2->SetEntries(4849.694);
   hEff2->SetStats(0);
