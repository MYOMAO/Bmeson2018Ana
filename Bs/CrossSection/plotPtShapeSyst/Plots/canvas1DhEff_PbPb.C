...
//=========  (Tue Sep 17 14:00:00 2019) by ROOT version6.02/13
   ...
   hemptyEff1->Draw("");
   Double_t xAxis1[4] = {5, 15, 20, 50}; 
   
   TH1D *hEff2 = new TH1D("hEff2","",3, xAxis1);
   hEff2->SetBinContent(1,0.00358709);
   hEff2->SetBinContent(2,0.04694059);
   hEff2->SetBinContent(3,0.1010473);
   hEff2->SetBinError(1,0.0001087133);
   hEff2->SetBinError(2,0.001029776);
   hEff2->SetBinError(3,0.001290022);
   hEff2->SetEntries(8396.013);
   hEff2->SetStats(0);
