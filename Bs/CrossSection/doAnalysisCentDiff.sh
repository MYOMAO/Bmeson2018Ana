...
DOANALYSISPbPb_FITCOMP=0
DOANALYSISPbPb_PTSHAPESYST=0
DOANALYSISPbPb_CROSSCOMP=0

DOANALYSISPbPb_EFFPLOT=1
DOANALYSISPbPb_YIELD=0

OUTPUTFILEPlotPbPb_NOMINALPP="ROOTfiles/CrossSectionPbPbNOMINALPP_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_VARIATIONPP="ROOTfiles/CrossSectionPbPbVARIATIONPP_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_NOMINALTAMU="ROOTfiles/CrossSectionPbPbNOMINALTAMU_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_VARIATIONTAMU="ROOTfiles/CrossSectionPbPbVARIATIONTAMU_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

OUTPUTFILEPlotPbPb_NO="ROOTfiles/CrossSectionPbPbNO_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

OUTPUTFILEPlotPbPb_LINEAR="ROOTfiles/CrossSectionPbPbLINEAR_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_QUADRATIC="ROOTfiles/CrossSectionPbPbQUADRATIC_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_LINVERSE="ROOTfiles/CrossSectionPbPbLINVERSE_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_LSQRT="ROOTfiles/CrossSectionPbPbLSQRT_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
OUTPUTFILEPlotPbPb_LLOG="ROOTfiles/CrossSectionPbPbLLOG_${CENTPbPbMIN}_${CENTPbPbMAX}.root"


WEIGHTEDEFFOUTFILE_NOMINALPP="plotPtShapeSyst/Files/EffWeightedNOMINALPP_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
WEIGHTEDEFFOUTFILE_VARIATIONPP="plotPtShapeSyst/Files/EffWeightedVARIATIONPP_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
WEIGHTEDEFFOUTFILE_NO="plotPtShapeSyst/Files/EffWeightedNO_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

WEIGHTEDEFFOUTFILE_LINEAR="plotPtShapeSyst/Files/EffWeightedLINEAR_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
WEIGHTEDEFFOUTFILE_QUADRATIC="plotPtShapeSyst/Files/EffWeightedQUADRATIC_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
WEIGHTEDEFFOUTFILE_LINVERSE="plotPtShapeSyst/Files/EffWeightedLINVERSE_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
WEIGHTEDEFFOUTFILE_LSQRT="plotPtShapeSyst/Files/EffWeightedLSQRT_${CENTPbPbMIN}_${CENTPbPbMAX}.root"
WEIGHTEDEFFOUTFILE_LLOG="plotPtShapeSyst/Files/EffWeightedLLOG_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

OUTPUTFILEPbPb="ROOTfiles/hPtSpectrumBplusPbPb_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

WEIGHTEDEFFOUTFILE_LLOGY="plotPtShapeSyst/Files/EffWeightedLLOGY_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

OUTPUTFILEPbPbONPT="ROOTfiles/hPtSpectrumBplusPbPb_PT_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

OUTPUTFILEPbPbONY="ROOTfiles/hPtSpectrumBplusPbPb_Y_${CENTPbPbMIN}_${CENTPbPbMAX}.root"

if [ $DOANALYSISPbPb_YIELD -eq 1 ]; then     

echo "JUST SAVE ALL YIELD PLOTS vs CENT DIFF"	

echo "Working on PT"
g++ fitBCentDiff.C $(root-config --cflags --libs) -g -o fitBCentDiff.exe 
#./fitBCentDiff.exe 1 0 "$INPUTDATAPbPbCANDWISE" "$INPUTMCPbPbCANDWISE" "Bpt" "$TRGPbPb" "$CUTPbPb" "$SELGENPbPb" "$ISMCPbPb" 1 "$ISDOWEIGHTPbPb" "$LABELPbPb" "$OUTPUTFILEPbPb" "plotFits/plotFits" "$NPFIT_PbPb" 0 "$CENTPbPbMIN" "$CENTPbPbMAX"
#./fitBCentDiff.exe 1 0 "$INPUTDATAPbPbCANDWISE" "$INPUTMCPbPbCANDWISE" "Bpt" "$TRGPbPb" "$CUTPbPb" "$SELGENPbPb" "$ISMCPbPb" 1 "$ISDOWEIGHTPbPb" "$LABELPbPb" "$OUTPUTFILEPbPbONPT" "plotFits/plotFits/plotFitsCentPT" "$NPFIT_PbPb" 0 "$CENTPbPbMIN" "$CENTPbPbMAX"

echo "Working on CENT"


./fitBCentDiff.exe 1 0 "$INPUTDATAPbPbCANDWISE" "$INPUTMCPbPbCANDWISE" "abs(By)" "$TRGPbPb" "$CUTPbPb" "$SELGENPbPb" "$ISMCPbPb" 1 "$ISDOWEIGHTPbPb" "$LABELPbPb" "$OUTPUTFILEPbPbONY" "plotFits/plotFitsCentY" "$NPFIT_PbPb" 0 "$CENTPbPbMIN" "$CENTPbPbMAX"
...
if [ $DOANALYSISPbPb_EFFPLOT -eq 1 ]; then     

echo "JUST SAVE ALL PLOTS vs CENT DIFF"	
g++ MCefficiencyCentDiff.C $(root-config --cflags --libs) -g -o MCefficiencyCentDiff.exe 

#./MCefficiency.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "abs(By)" "Gy"  "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_LLOGY" "plotPtShapeSyst/PlotsY_${CENTPbPbMIN}_${CENTPbPbMAX}" 15 "$CENTPbPbMIN" "$CENTPbPbMAX"

./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_LLOG" "plotPtShapeSyst/PlotsPt_${CENTPbPbMIN}_${CENTPbPbMAX}" 15 "$CENTPbPbMIN" "$CENTPbPbMAX"




rm MCefficiencyCentDiff.exe
...
if [ $DOANALYSISPbPb_FITCOMP -eq 1 ]; then      
g++ fitBCentDiff.C $(root-config --cflags --libs) -g -o fitBCentDiff.exe 
./fitBCentDiff.exe 1 0 "$INPUTDATAPbPbCANDWISE" "$INPUTMCPbPbCANDWISE" "Bpt" "$TRGPbPb" "$CUTPbPb" "$SELGENPbPb" "$ISMCPbPb" 1 "$ISDOWEIGHTPbPb" "$LABELPbPb" "$OUTPUTFILEPbPb" "plotFits/plotFits" "$NPFIT_PbPb" 0 "$CENTPbPbMIN" "$CENTPbPbMAX"
rm fitBCentDiff.exe
fi 
...
g++ MCefficiencyCentDiff.C $(root-config --cflags --libs) -g -o MCefficiencyCentDiff.exe 
./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_NOMINALPP" "plotPtShapeSyst/Plots" 3 "$CENTPbPbMIN" "$CENTPbPbMAX"
./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_VARIATIONPP" "plotPtShapeSyst/Plots" 4 "$CENTPbPbMIN" "$CENTPbPbMAX"
...
#./MCefficiency.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_NO" "plotPtShapeSyst/Plots" 16 "$CENTPbPbMIN" "$CENTPbPbMAX"

./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_LINEAR" "plotPtShapeSyst/Plots" 11 "$CENTPbPbMIN" "$CENTPbPbMAX"
./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_QUADRATIC" "plotPtShapeSyst/Plots" 12 "$CENTPbPbMIN" "$CENTPbPbMAX"
./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_LINVERSE" "plotPtShapeSyst/Plots" 13 "$CENTPbPbMIN" "$CENTPbPbMAX"
./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_LSQRT" "plotPtShapeSyst/Plots" 14 "$CENTPbPbMIN" "$CENTPbPbMAX"
./MCefficiencyCentDiff.exe 1 "$INPUTMCPbPbCANDWISE" "$SELGENPbPb" "$SELGENPbPbACCPbPb" "$RECOONLYPbPb" "$CUTPbPb&&$TRGPbPbMC" "Bpt" "Gpt" "$LABELPbPb" "$WEIGHTEDEFFOUTFILE_LLOG" "plotPtShapeSyst/Plots" 15 "$CENTPbPbMIN" "$CENTPbPbMAX"

rm MCefficiencyCentDiff.exe
fi


if [ $DOANALYSISPbPb_CROSSCOMP -eq 1 ]; then      
g++ CrossSectionRatio.C $(root-config --cflags --libs) -g -o CrossSectionRatio.exe 
./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_NOMINALPP" "$OUTPUTFILEPlotPbPb_NOMINALPP" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_VARIATIONPP" "$OUTPUTFILEPlotPbPb_VARIATIONPP" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
#./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_NOMINALTAMU" "$OUTPUTFILEPlotPbPb_NOMINALTAMU" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
#./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_VARIATIONTAMU" "$OUTPUTFILEPlotPbPb_VARIATIONTAMU" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
#./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_NO" "$OUTPUTFILEPlotPbPb_NO" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0



./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_LINEAR" "$OUTPUTFILEPlotPbPb_LINEAR" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_QUADRATIC" "$OUTPUTFILEPlotPbPb_QUADRATIC" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_LINVERSE" "$OUTPUTFILEPlotPbPb_LINVERSE" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_LSQRT" "$OUTPUTFILEPlotPbPb_LSQRT" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
./CrossSectionRatio.exe "$FONLLOUTPUTFILE" "$OUTPUTFILEPbPb" "$WEIGHTEDEFFOUTFILE_LLOG" "$OUTPUTFILEPlotPbPb_LLOG" "plotCrossSection/plotCrossSectionComp" 1 "$LABELPbPb" 0 0 "$LUMIPbPb" "$CENTPbPbMIN" "$CENTPbPbMAX" 0
rm CrossSectionRatio.exe
