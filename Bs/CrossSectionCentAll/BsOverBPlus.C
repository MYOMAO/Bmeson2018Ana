...
//	NPartPlot->Draw("epx0");
	...
	TLatex* texcent = new TLatex(0.42,0.80,"B p_{T} 5 - 50 GeV/c");
	texcent->SetNDC();
	...
	TLatex* Bin1 = new TLatex(0.45,0.75,"Cent. 0 - 90%");
	Bin1->SetNDC();
	...
	TLegend* leg = new TLegend(0.52,0.25,0.70,0.67,NULL,"brNDC");
	leg->SetBorderSize(0);
